...
const LineChart = () => {
    const gadgetShoppingData = [
        ...
        { customerId: 4, productName: 'Smartwatch', model: 'Apple Watch Series 8', priceSpent: 450 },
        { customerId: 5, productName: 'Headphones', model: 'Sony WH-1000XM5', priceSpent: 300 },
        ...
        { customerId: 9, productName: 'Headphones', model: 'Bose QuietComfort 45', priceSpent: 150 },
        { customerId: 10, productName: 'Tablet', model: 'Samsung Galaxy Tab S8', priceSpent: 400 }
      ];
